  ...
  return (
    <div className="mx-auto flex min-h-[80vh] max-w-md flex-col justify-center px-4 py-16 sm:px-6">
      ...
      <p className="mt-2 text-black/70">
        Sign in with Google or your email and password to access the app.
      </p>
      <div className="mt-8 space-y-6">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border border-black/20 py-2.5 font-medium text-black hover:bg-black/5 transition-colors"
        >
        ...
        <p className="text-center text-sm text-black/60">
          ...
          <Link href="/register" className="font-medium text-[#7961A9] hover:underline">
            Sign up
          </Link>
        </p>
      </div>
